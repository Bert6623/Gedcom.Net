...
/* [start] feature=google.blog */
google.Blog=function(a){var b=this;gadgets.rpc.call(null,"getBlogUrls",function(c){b.currentPost=c.currentPost||null;b.currentComments=c.currentComments||null;b.postFeed=c.postFeed||null;b.commentFeed=c.commentFeed||null;b.currentBlogUrl=c.currentBlogUrl||null;b.currentPostUrl=c.currentPostUrl||null;b.currentBlogId=c.currentBlogId||null;b.currentPostId=c.currentPostId||null;b.initialized=!0;window.setTimeout(function(){a()},100)})};
google.Blog.prototype.getPostsFeedUrl=function(){if(!this.initialized)throw"Not initialized";return this.postFeed};google.Blog.prototype.getPostsJson=function(a){this.getFeedAsJson(this.getPostsFeedUrl(),a)};google.Blog.prototype.getCommentsFeedUrl=function(){if(!this.initialized)throw"Not initialized";return this.commentFeed};google.Blog.prototype.getCommentsJson=function(a){this.getFeedAsJson(this.getCommentsFeedUrl(),a)};
google.Blog.prototype.getCurrentPostFeedUrl=function(){if(!this.initialized)throw"Not initialized";return this.currentPost};google.Blog.prototype.getCurrentPostJson=function(a){this.getFeedAsJson(this.getCurrentPostFeedUrl(),a)};google.Blog.prototype.getCurrentCommentsFeedUrl=function(){if(!this.initialized)throw"Not initialized";return this.currentComments};google.Blog.prototype.getCurrentCommentsJson=function(a){this.getFeedAsJson(this.getCurrentCommentsFeedUrl(),a)};
google.Blog.prototype.getFeedAsJson=function(a,b){if(a){var c={};c[gadgets.io.RequestParameters.CONTENT_TYPE]=gadgets.io.ContentType.JSON;gadgets.io.makeRequest(a+"?alt=json",b,c)}else b(null)};google.Blog.prototype.getCurrentBlogUrl=function(){if(!this.initialized)throw"Not initialized";return this.currentBlogUrl};google.Blog.prototype.getCurrentPostUrl=function(){if(!this.initialized)throw"Not initialized";return this.currentPostUrl};
google.Blog.prototype.getCurrentBlogId=function(){if(!this.initialized)throw"Not initialized";return this.currentBlogId};google.Blog.prototype.getCurrentPostId=function(){if(!this.initialized)throw"Not initialized";return this.currentPostId};
;

/* [end] feature=google.blog */
(function(){var j=window['___jsl']=window['___jsl']||{};j['l']=(j['l']||[]).concat(['google.blog']);})();(function(){var j=window['___jsl']=window['___jsl']||{};if(j['c']){j['c']();delete j['c'];}})();