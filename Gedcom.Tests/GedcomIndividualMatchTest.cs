...
namespace Gedcom
{
	...
	{	
		...
		public void Test1()
		{
			...
			NUnit.Framework.Assert.IsTrue(match == 100.0F, "Individual failed to match themself", null);
			...
			NUnit.Framework.Assert.IsTrue(match != 100.0F, "Individual matched another 100%", null);
