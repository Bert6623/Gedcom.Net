/*
 *  $Id: SourceList.cs 189 2008-10-10 14:16:10Z davek $
 * 
...
namespace Gedcom.UI.GTK.Widgets
{
	...
	public partial class SourceList : Gtk.Bin
	{
		#region Variables
		...
		protected SourceListModel _listModel;
...
//			SourceTreeView.AppendColumn(dateCol);
		...
		public GedcomDatabase Database
		{
			...
			set
			{
				...
				SourceTreeView.Model = _listModel.Adapter;
			}
		}
		...
		private bool Refilter()
		{
			...
			_listModel.FilterType = (SourceListModel.SourceFilterType)FilterComboBox.Active;
			_listModel.DoFill();
