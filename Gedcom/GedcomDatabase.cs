...
namespace Gedcom
{
	...
	public class GedcomDatabase : IEnumerator
	{
		...
		private Utility.IndexedKeyCollection _nameCollection;
		private Utility.IndexedKeyCollection _placeNameCollection;
		...
		public GedcomDatabase()
		{
			...
			_nameCollection = new Utility.IndexedKeyCollection();
			_placeNameCollection = new Utility.IndexedKeyCollection();
