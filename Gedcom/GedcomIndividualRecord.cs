...
namespace Gedcom
{
	...
	public class GedcomIndividualRecord : GedcomRecord, IComparable
	{
		...
		{
			get { return _PermanentRecordFileNumber; }
			set 
			{ 
		...
		{
			get { return _AncestralFileNumber; }
			set 
			{ 
		...
		{
			get	{ return FindEvent(GedcomEvent.GedcomEventType.BIRT); }
		}
		
		public GedcomIndividualEvent Death
		{
			get { return FindEvent(GedcomEvent.GedcomEventType.DEAT); }
		}

		public GedcomIndividualEvent Height
		{
			get { return Attributes.Find(a => a.EventType == GedcomEvent.GedcomEventType.GenericFact && string.Compare(a.EventName, "Height") == 0); }
		}

		public GedcomIndividualEvent Weight
		{
			get { return Attributes.Find(a => a.EventType == GedcomEvent.GedcomEventType.GenericFact && string.Compare(a.EventName, "Weight") == 0); }
		}

		public GedcomIndividualEvent Medical
		{
			get { return Attributes.Find(a => a.EventType == GedcomEvent.GedcomEventType.GenericFact && string.Compare(a.EventName, "Medical") == 0); }
		}
		...
		public override GedcomChangeDate ChangeDate 
		{
			get 
			{  
				// NOTE: we ignore Address as it is a hack and will not be
				// set except during reading a gedcom file, it will be turned into a RESI
