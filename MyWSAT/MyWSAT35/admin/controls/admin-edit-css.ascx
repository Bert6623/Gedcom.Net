<%@ Control Language="C#" AutoEventWireup="true" CodeFile="admin-edit-css.ascx.cs" Inherits="admin_controls_admin_edit_css" %>
...
<div class="gvBanner">
    <span class="gvBannerThemes">
        <asp:Image ID="Image2" runat="server" ImageAlign="AbsMiddle" ImageUrl="~/images/decoy-icon-36px.png" /></span> Add / Edit Admin CSS</div>
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="CssId" DataSourceID="ObjectDataSource1" EnableModelValidation="True" CssClass="gv" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" ShowFooter="True" OnDataBound="GridView1_DataBound" OnRowDataBound="GridView1_RowDataBound">
    <Columns>
        <asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="EDIT">
            ...
            <FooterTemplate>
                <asp:LinkButton ID="btnInsert" runat="server" CausesValidation="True" Text="Insert" OnClick="btnInsert_Click" ValidationGroup="newCss"></asp:LinkButton>
            </FooterTemplate>
            <ItemTemplate>
                <asp:LinkButton ID="btnEdit" runat="server" CausesValidation="False" CommandName="Edit" Text="Edit"></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="CSS URL" SortExpression="CssUrl">
            <EditItemTemplate>
                <asp:TextBox ID="txtCssUrl" runat="server" Text='<%# Bind("CssUrl") %>' MaxLength="255"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvCssUrl" runat="server" ControlToValidate="txtCssUrl" Display="Dynamic" ErrorMessage="CSS Url is required!"></asp:RequiredFieldValidator>
            </EditItemTemplate>
            <FooterTemplate>
                <asp:TextBox ID="txtCssUrlNew" runat="server" MaxLength="255"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvCssUrlNew" runat="server" ControlToValidate="txtCssUrlNew" Display="Dynamic" ErrorMessage="CSS Url is required!" ValidationGroup="newCss"></asp:RequiredFieldValidator>
            </FooterTemplate>
            <ItemTemplate>
                <span class="gvShortcut">
                    <a href='edit_css_modal.aspx?cssid=<%# Eval("CssId") %>' rel="gb_page_center[800, 500]" title="Edit CSS File"><%# Eval("CssUrl") %></a>
                </span>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="CSS NAME" SortExpression="CssName">
            <EditItemTemplate>
                <asp:TextBox ID="txtCssName" runat="server" Text='<%# Bind("CssName") %>' MaxLength="100"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvCssName" runat="server" ControlToValidate="txtCssName" Display="Dynamic" ErrorMessage="Please name your CSS file!"></asp:RequiredFieldValidator>
            </EditItemTemplate>
            <FooterTemplate>
                <asp:TextBox ID="txtCssNameNew" runat="server" MaxLength="100"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvCssName" runat="server" ControlToValidate="txtCssNameNew" Display="Dynamic" ErrorMessage="Please name your CSS!" ValidationGroup="newCss"></asp:RequiredFieldValidator>
            </FooterTemplate>
            <ItemTemplate>
                <asp:Label ID="lblCssName" runat="server" Text='<%# Bind("CssName") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="DESCRIPTION" SortExpression="CssDescription">
            <EditItemTemplate>
                <asp:TextBox ID="txtCssDescription" runat="server" Text='<%# Bind("CssDescription") %>' MaxLength="255"></asp:TextBox>
            </EditItemTemplate>
            <FooterTemplate>
                <asp:TextBox ID="txtCssDescriptionNew" runat="server" MaxLength="255"></asp:TextBox>
            </FooterTemplate>
            <ItemTemplate>
                <asp:Label ID="lblCssDescription" runat="server" Text='<%# Bind("CssDescription") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetAdminCss" TypeName="sp_cpanelTableAdapters.site_ThemeCssTableAdapter" UpdateMethod="Update" OnSelected="ObjectDataSource1_Selected">
    <DeleteParameters>
        <asp:Parameter Name="Original_CssId" Type="Int32" />
    </DeleteParameters>
    <UpdateParameters>
        <asp:Parameter Name="CssUrl" Type="String" />
        <asp:Parameter Name="CssName" Type="String" />
        <asp:Parameter Name="CssDescription" Type="String" />
...
<asp:Panel ID="pnlHideItems" runat="server" Visible="false">
    ...
    <div class="buttonCSS">
        <asp:LinkButton ID="btnDeleteSelected" runat="server" OnClick="btnDeleteSelected_Click" OnClientClick="return confirm('DELETE selected CSS(s)?');" ToolTip="DELETE the selected CSS(s).">Delete</asp:LinkButton>
    </div>
</asp:Panel>
<div class="padding">
</div>
...
<div id="helpSidebar" class="helpSidebar" style="display: none;">
    ...
    <div>
        ...
        <asp:XmlDataSource ID="xmlHelp" runat="server" DataFile="~/admin/help/admin-edit-css.xml"></asp:XmlDataSource>
    </div>
</div>
<%-- sidebar help js --%>
