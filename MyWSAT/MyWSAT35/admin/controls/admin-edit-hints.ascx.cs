...
public partial class admin_controls_admin_edit_hints : System.Web.UI.UserControl
{
        ...
        foreach (GridViewRow row in GridView1.Rows)
        {
            ...
            if (cb != null && cb.Checked)
            {
                try
                {
                    ...
                    ObjectDataSource1.DeleteParameters["Original_helpId"].DefaultValue = deleteSelected.ToString();
    ...
    #region Register Hint File

    protected void btnInsert_Click(object sender, EventArgs e)
    {
        TextBox txtHintUrlNew = GridView1.FooterRow.FindControl("txtHintUrlNew") as TextBox;
        TextBox txtHintNameNew = GridView1.FooterRow.FindControl("txtHintNameNew") as TextBox;
        TextBox txtHintDescriptionNew = GridView1.FooterRow.FindControl("txtHintDescriptionNew") as TextBox;
        TextBox txtHintCategoryNew = GridView1.FooterRow.FindControl("txtHintCategoryNew") as TextBox;

        ObjectDataSource1.InsertParameters["HintUrl"].DefaultValue = txtHintUrlNew.Text.Trim();
        ObjectDataSource1.InsertParameters["HintName"].DefaultValue = txtHintNameNew.Text.Trim();
        ObjectDataSource1.InsertParameters["HintDescription"].DefaultValue = txtHintDescriptionNew.Text.Trim();
        ObjectDataSource1.InsertParameters["HintCategory"].DefaultValue = txtHintCategoryNew.Text.Trim();
        ...
        try
        {
            ...
            Msg.Text = "Hint File REGISTRATION was successful.";
            Msg.Visible = true;
        }
        catch (Exception ex)
        {
