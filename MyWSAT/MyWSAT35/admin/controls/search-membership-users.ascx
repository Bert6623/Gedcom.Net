<%@ Control Language="C#" AutoEventWireup="true" CodeFile="search-membership-users.ascx.cs" Inherits="admin_controls_search_membership_users" %>
...
<%-- gridview for user search --%>
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" EmptyDataText="No records found..." OnDataBound="GridView1_DataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDataBound="GridView1_RowDataBound" DataKeyNames="userName" CssClass="gv">
    <Columns>
        <asp:TemplateField>
...
<%-- gridview datasource --%>
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="sp_wsat_GetUsersBySearch" TypeName="sp_wsat_Users" EnablePaging="True" SelectCountMethod="TotalNumberOfUsersBySearch" OnSelected="ObjectDataSource1_Selected">
    <SelectParameters>
...
<div id="helpSidebar" class="helpSidebar" style="display: none;">
    ...
    <div>
        ...
        <asp:XmlDataSource ID="xmlHelp" runat="server" DataFile="~/admin/help/search-membership-users.xml"></asp:XmlDataSource>
    </div>
</div>
<%-- sidebar help js --%>
