<%@ Control Language="C#" AutoEventWireup="true" CodeFile="unapproved-users.ascx.cs" Inherits="admin_controls_unapproved_users" %>
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" DataKeyNames="userName" EmptyDataText="No records found." OnDataBound="GridView1_DataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDataBound="GridView1_RowDataBound" CssClass="gv">
    <Columns>
        ...
        <asp:TemplateField HeaderText="DEL">
            ...
            <ItemTemplate>
                <asp:CheckBox ID="chkRows" runat="server" ToolTip="Check to Select this User" />
            </ItemTemplate>
...
<%-- gridview datasource --%>
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="sp_wsat_GetUsersByIsApproved" TypeName="sp_wsat_Users" EnablePaging="True" SelectCountMethod="TotalNumberOfUsersByIsApproved" OnSelected="ObjectDataSource1_Selected"></asp:ObjectDataSource>
<%-- show/hide panel --%>
...
<div id="helpSidebar" class="helpSidebar" style="display: none;">
    ...
    <div>
        ...
        <asp:XmlDataSource ID="xmlHelp" runat="server" DataFile="~/admin/help/unapproved-users.xml"></asp:XmlDataSource>
    </div>
</div>
<%-- sidebar help js --%>
