<%@ Control Language="C#" AutoEventWireup="true" CodeFile="users-a-to-z.ascx.cs" Inherits="admin_controls_users_a_to_z" %>
...
<div id="helpSidebar" class="helpSidebar" style="display: none;">
    ...
    <div>
        ...
        <asp:XmlDataSource ID="xmlHelp" runat="server" DataFile="~/admin/help/users-a-to-z.xml"></asp:XmlDataSource>
    </div>
</div>
<%-- sidebar help js --%>
