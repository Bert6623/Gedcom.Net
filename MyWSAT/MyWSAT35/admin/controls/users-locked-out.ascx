<%@ Control Language="C#" AutoEventWireup="true" CodeFile="users-locked-out.ascx.cs" Inherits="admin_controls_users_locked_out" %>
...
<%-- gridview datasource --%>
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="sp_wsat_GetUsersByIsLockedOut" TypeName="sp_wsat_Users" EnablePaging="True" SelectCountMethod="TotalNumberOfUsersByIsLockedOut" OnSelected="ObjectDataSource1_Selected"></asp:ObjectDataSource>
...
<div id="helpSidebar" class="helpSidebar" style="display: none;">
    ...
    <div>
        ...
        <asp:XmlDataSource ID="xmlHelp" runat="server" DataFile="~/admin/help/users-locked-out.xml"></asp:XmlDataSource>
    </div>
</div>
<%-- sidebar help js --%>
