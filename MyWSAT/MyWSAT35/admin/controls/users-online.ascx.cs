...
public partial class admin_controls_users_online : System.Web.UI.UserControl
{
    #region PageLoad - HIDE following ITEMS when gridview is empty - ADD attributes to DDLs

    protected void Page_Load(object sender, EventArgs e)
    {
        UserGvUtil.HidePanelIfGridviewIsEmpty(pnlHideItems, GridView1);
        UserGvUtil.ShowNumberOfUsersOnline(totalRecordCount);
    ...
    protected void ObjectDataSource1_Selected(object sender, ObjectDataSourceStatusEventArgs e)
    {
        ...
        UserGvUtil.ShowTotalRecordCountDataTable(e, totalRecordCount);
    }
    ...
    // setup gridview sorting to work with css
